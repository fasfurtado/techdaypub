...
var classnames = __webpack_require__(468);
...
var pathProdutos='https://mercado.carrefour.com.br/api/catalog_system/pub/products/search?fq=';//Api do carrefour para buscar os produtos da loja enviada no parametro postalcode (cep)
var pathLojas='https://mercado.carrefour.com.br/api/checkout/pub/regions?country=BRA&postalCode=';var headers={method:'GET',mode:'cors',cache:'default',headers:{"Accept":"application/json"}};//função que busca no link do carrefour os produtos relacionados a loja
function getProdutos(_x){return _getProdutos.apply(this,arguments);}//função que busca no link do carrefour as lojas mais próximas do CEP informado
function _getProdutos(){_getProdutos=_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(loja){var resposta;return _regeneratorRuntime().wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:if(!loja){_context.next=10;break;}console.log(loja);console.log("".concat(pathProdutos).concat(loja));_context.next=5;return fetch("".concat(pathProdutos).concat(loja),headers).then(function(response){return response.json();}).catch(console.log("carregando produtos..."));case 5:resposta=_context.sent;console.log(resposta);return _context.abrupt("return",resposta);case 10:return _context.abrupt("return",[]);case 11:case"end":return _context.stop();}}},_callee);}));return _getProdutos.apply(this,arguments);}function getLojas(_x2){return _getLojas.apply(this,arguments);}function _getLojas(){_getLojas=_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(cep){var resplojas,respfinal;return _regeneratorRuntime().wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:if(!cep){_context2.next=12;break;}console.log("getLojas: cep: "+cep);console.log("".concat(pathLojas).concat(cep));_context2.next=5;return fetch("".concat(pathLojas).concat(cep)).then(function(response){return response.json();}).catch(console.log("carregando lojas..."));case 5:resplojas=_context2.sent;console.log('carregou lojas..(sellers)');console.log(resplojas['0'].sellers);respfinal=resplojas['0'].sellers;//console.log("Api.getLojas: PRIMEIRA LOJA "  + respfinal['0'].id)
return _context2.abrupt("return",respfinal);case 12:return _context2.abrupt("return",[]);case 13:case"end":return _context2.stop();}}},_callee2);}));return _getLojas.apply(this,arguments);}/* harmony default export */ var Api = ({getProdutos:getProdutos,getLojas:getLojas});
;// CONCATENATED MODULE: ./src/commons/styles/asset.min.css
// extracted by mini-css-extract-plugin
/* harmony default export */ var asset_min = ({});
;// CONCATENATED MODULE: ./src/commons/styles/styles.css
// extracted by mini-css-extract-plugin
/* harmony default export */ var styles = ({});
;// CONCATENATED MODULE: ./src/components/Cep.jsx
function Cep(props){var _useState=(0,react.useState)(''),_useState2=_slicedToArray(_useState,2),cep=_useState2[0],setCep=_useState2[1];var mcepbutton=document.getElementById("cepbutton");var mcepvalue=document.getElementById("cepvalue");mcepvalue.addEventListener('change',function(e){console.log(e.target.value);setCep(e.target.value);});mcepbutton.addEventListener('click',function(e){return handleSubmit(e.target.value);});var handleSubmit=function handleSubmit(event){console.log("CEP handleSubmit: "+cep);//executa em lojas o handleCepChange que foi enviado através do props
props.onCepChange(cep);};//não será mais necessário porque estão sendo utilizados os campos do cabeçalho existente
/* <div>
...
</div> */ //o componente Cep renderiza em branco porque estão sendo utilizados os campos do cabeçalho existente
...
var Row_excluded = ["bsPrefix", "className", "as"];
...
var Row = /*#__PURE__*/react.forwardRef(function (_ref, ref) {
  var bsPrefix = _ref.bsPrefix,
      ...
      _ref$as = _ref.as,
      Component = _ref$as === void 0 ? 'div' : _ref$as,
      props = _objectWithoutProperties(_ref, Row_excluded);
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(Component, _objectSpread2(_objectSpread2({
    ...
    className: classnames_default().apply(void 0, [className, decoratedBsPrefix].concat(classes))
  }));
});
Row.displayName = 'Row';
...
var Col_DEVICE_SIZES = ['xxl', 'xl', 'lg', 'md', 'sm', 'xs'];
...
// extracted by mini-css-extract-plugin
/* harmony default export */ var bootstrap_min = ({});
;// CONCATENATED MODULE: ./src/components/Produtos.jsx
function Produtos(props){//console.log("ENTROU PRODUTOS");
var loja=props.loja;var _useState=(0,react.useState)([]),_useState2=_slicedToArray(_useState,2),produtosData=_useState2[0],setProdutosData=_useState2[1];var getProdutosData=(0,react.useCallback)(function(loja){Api.getProdutos(loja).then(function(produtosData){return setProdutosData(produtosData);}).catch(console.log("carregando produtos...")).finally(console.log("carregou produtos da loja."));},[loja]);(0,react.useEffect)(function(){//Executa somente uma vez, e pega os produtos da loja
console.log("vai carregar os produtos da loja (1st).");getProdutosData(loja);},[]);(0,react.useEffect)(function(){if(loja){console.log("Mudou a loja em Produtos: "+loja);getProdutosData(loja);}},[loja]);if(!loja==""){return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("label",{className:"vtex-rich-text-0-x-paragraph--institutional-main-text",children:["Produtos Dispon\xEDveis na loja: ",loja]}),/*#__PURE__*/(0,jsx_runtime.jsx)(esm_Container,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(esm_Row,{children:produtosData.map(function(produtosData,k){return/*#__PURE__*/(0,jsx_runtime.jsx)(esm_Col,{xs:12,md:4,lg:3,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(esm_Card,{variant:"outlined",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(esm_Card.Img,{variant:"top",src:produtosData.items[0].images[0].imageUrl}),/*#__PURE__*/(0,jsx_runtime.jsxs)(esm_Card.Body,{className:"card-body",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(esm_Card.Title,{className:"card-title",children:["Id: ",produtosData.productId]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(esm_Card.Text,{className:"card-description",children:["Descri\xE7\xE3o: ",produtosData.productName,/*#__PURE__*/(0,jsx_runtime.jsx)("br",{}),/*#__PURE__*/(0,jsx_runtime.jsxs)("b",{children:["Qtde: ",produtosData.items[0].sellers[0]['commertialOffer'].AvailableQuantity,"\xA0","\xA0","\xA0","\xA0","\xA0","Pre\xE7o: ",produtosData.items[0].sellers[0]['commertialOffer'].Installments[0].Value]})]})]})]})},k);})})})]});}else{return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{});}};
;// CONCATENATED MODULE: ./src/components/Lojas.jsx
function Lojas(){var selectedLoja=(0,react.useRef)();var _useState=(0,react.useState)(''),_useState2=_slicedToArray(_useState,2),loja=_useState2[0],setLoja=_useState2[1];var _useState3=(0,react.useState)([]),_useState4=_slicedToArray(_useState3,2),lojasData=_useState4[0],setLojasData=_useState4[1];var _useState5=(0,react.useState)(''),_useState6=_slicedToArray(_useState5,2),cep=_useState6[0],setCep=_useState6[1];var getLojasData=(0,react.useCallback)(function(cep){//Pega a lista de lojas próximas ao CEP do usuário
Api.getLojas(cep).then(function(lojasData){setLojasData(lojasData);console.log("Agora carregou lojasData e vai colocar no ref a primeira loja mais próxima...");selectedLoja.current=lojasData['0'].id;setLoja(selectedLoja.current);console.log("selectedLoja = "+selectedLoja.current);}).catch(console.log("carregando lojas..."));},[]);(0,react.useEffect)(function(){//Executa toda vez que o CEP for alterado, e se o CEP não for nulo pega as lojas do CEP
console.log("passou no loja useeffect change cep");if(cep){getLojasData(cep);}},[cep]);var handleLojaChange=function handleLojaChange(value){//Executa quando o usuário troca a loja na Caixa de Seleção de Lojas da página
console.log("Mudou a loja no handleLojaChange: "+value);setLoja(value);selectedLoja.current=value;console.log(value);};var handleCepChange=function handleCepChange(value){//Executa quando o CEP for alterado no componente <Cep />, onde essa função foi passada pelo <props>
console.log("MUDOU O CEP no handleCepChange: "+value);//altera o estado cep
setCep(value.replace("-",""));//pega as lojas do cep alterado
getLojasData(value.replace("-",""));};var renderLoja=/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"form-control w-100 flex",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("label",{className:"form-label",children:"Escolha a loja de sua prefer\xEAncia :\xA0\xA0"}),/*#__PURE__*/(0,jsx_runtime.jsx)(esm_FormSelect,{className:"form-select",value:loja,onChange:function onChange(e){return handleLojaChange(e.target.value);},children:lojasData.map(function(a,b){return/*#__PURE__*/(0,jsx_runtime.jsx)("option",{value:a['id'],children:a['name']});})})]});return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Cep,{onCepChange:function onCepChange(e){return handleCepChange(e);}}),renderLoja,/*#__PURE__*/(0,jsx_runtime.jsx)(Produtos,{loja:selectedLoja.current})]});}
;// CONCATENATED MODULE: ./src/index.js
console.log(document.getElementById('main'));var root=client.createRoot(document.getElementById('main'));root.render(/*#__PURE__*/(0,jsx_runtime.jsx)(Lojas,{}));
}();
/******/ })()
;
//# sourceMappingURL=main.55f97dbf.js.map